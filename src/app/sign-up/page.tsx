  ...
  "
                    >
                        ...
                        <div className="grid grid-cols justify-center items-center mt-3">
                            ...
                            <h4 className="flex justify-center items-center text-gray-300 text-sm mt-2 gap-1">Bạn đã có tài khoản?<Link href="/sign-in" className="text-white hover:text-secondary hover:font-bold">Đăng nhập!</Link></h4>
                        </div>
                        ...
                        <div className="flex justify-center items-center p-5 mt-4">
                            <FieldGroup>
                                ...
                                <Field orientation="horizontal">
                                    <Button type="submit" className="w-full h-10 mt-5 bg-primary">Đăng ký</Button>
                                </Field>
                            </FieldGroup>
                        </div>
