    ...
    return (
        <div>
            <div className="relative flex flex-col h-screen overflow-hidden bg-grayDarkest">
                ...
                <div className="absolute top-0 right-0 w-125 h-125 bg-purple-900/15 rounded-full blur-[120px] pointer-events-none" />
                <div className="absolute bottom-0 left-1/3 w-100 h-100 bg-blue-900/10 rounded-full blur-[100px] pointer-events-none" />
